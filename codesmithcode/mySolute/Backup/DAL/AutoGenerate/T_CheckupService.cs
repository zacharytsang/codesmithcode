...
namespace DAL
{
	public static partial class T_CheckupService
	{
        ...
        public static IList<T_Checkup> GetAllT_Checkups()
        {
        ...
        private static IList<T_Checkup> GetT_CheckupsBySql( string safeSql )
        {
        ...
        private static IList<T_Checkup> GetT_CheckupsBySql( string sql, params SqlParameter[] values )
        {
            List<T_Checkup> list = new List<T_Checkup>();
