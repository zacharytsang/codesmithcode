...
namespace DAL
{
	public static partial class T_RoleMenuRelationService
	{
        ...
        private static IList<T_RoleMenuRelation> GetT_RoleMenuRelationsBySql( string safeSql )
        {
        ...
        private static IList<T_RoleMenuRelation> GetT_RoleMenuRelationsBySql( string sql, params SqlParameter[] values )
        {
            List<T_RoleMenuRelation> list = new List<T_RoleMenuRelation>();
