...
namespace DAL
{
	public static partial class T_UserService
	{
		...
		{
            string sql =
				"INSERT T_User (username, password, role_id, status, create_date)" +
				"VALUES (@username, @password, @role_id, @status, @create_date)";
            ...
            try
            {
				...
				{
					new SqlParameter("@username", DBHelper.GetValueByWhetherNull(t_User.Username)),
        ...
        {
			return GetT_UsersBySql( sqlstring );
        }
        ...
        private static List<T_User> GetT_UsersBySql( string safeSql )
        {
        ...
        private static List<T_User> GetT_UsersBySql( string sql, params SqlParameter[] values )
        {
            List<T_User> list = new List<T_User>();
